...
export default function AssignmentEdit({ auth, subject, assignment, assignmentTypes = [], errors: serverErrors }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/subjects/${subject.id}/assignments/${assignment.id}`, {
            onSuccess: () => {
    ...
    // Get current date and time for minimum due date
    ...
    return (
        <Layout auth={auth} title={`Edit Assignment - ${assignment.name}`}>
            <Box sx={{ p: 3 }}>
                {/* Breadcrumbs */}
                <Breadcrumbs
                ...
                >
                    ...
                    <Typography color="text.primary">{t('edit')}</Typography>
                </Breadcrumbs>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={6}>
                                    <TextField
                                        ...
                                        inputProps={{
                                            min: assignment.is_completed ? undefined : getCurrentDateTime()
                                        }}
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12}>
                                    <Stack direction="row" spacing={2} sx={{ mt: 3 }}>
                                        <Button
                                            ...
                                            size="large"
                                        >
                                            {processing ? t('updatingAssignment') : t('updateAssignment')}
                                        </Button>
                                        <Button
                                            variant="outlined"
                                            component={Link}
